...
while($row_wise_data=mysqli_fetch_array($execute))
 {
	 ...
	 if($bio=="")
	  ...
	  echo "<div id='below'>";
	  echo "<h2 align='center'>Upload Photo</h2>";
	  echo "<div style='height:0px; width:98%; border:1px  solid #999; margin:auto; '></div><br /> <br /><br /> <br />";
	  echo "<form method='post' enctype='multipart/form-data'";
	  echo "<table align='center'";
	  echo "<tr><th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type='file' name='photo_file' style='margin:auto;' /></th></tr>"."<br /><br /><tr><th><input type='submit' name='sub' style='margin:auto;' value='Upload' /></th></tr></table></form>";
	  echo "</div>";  
